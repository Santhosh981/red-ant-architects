...
function TileProject() { const p = projects[0]; return <article className="project tile-project"><div className="tile-frame" data-cursor="VIEW">{Array.from({length: 7}, (_, i) => <div className="tile" key={i} style={{"--tile": i} as React.CSSProperties}><img src={p.image} width={1600} height={1104} alt={p.name} /></div>)}</div><Meta project={p} index={0} /></article>; }
function TheatreProject() { const p = projects[1]; return <article className="project theatre-project"><div className="theatre-image" data-cursor="VIEW"><img loading="lazy" src={p.image} width={1600} height={1104} alt={p.name} /></div><Meta project={p} index={1} /></article>; }
...
function CircularProject() { const p = projects[4]; return <article className="project circular-project"><div className="orbit"><span>LAT 55.6761° N</span><span>LONG 12.5683° E</span><span>BUILT / 2024</span><span>TYPE / COMMERCIAL</span></div><div className="circle-image" data-cursor="VIEW"><img loading="lazy" src={p.image} width={1600} height={1104} alt={p.name} /></div><Meta project={p} index={4} /></article>; }
function ZoomProject() { const p = projects[5]; return <article className="project zoom-project"><div className="zoom-under"><img loading="lazy" src={projects[6].image} width={1600} height={1104} alt={projects[6].name} /></div><div className="zoom-front"><img loading="lazy" src={p.image} width={1600} height={1104} alt={p.name} /></div><Meta project={p} index={5} /></article>; }
function SplitProject() { const p = projects[6]; return <article className="project split-project"><div className="split-media"><img loading="lazy" src={p.image} width={1600} height={1104} alt={p.name} /></div><div className="split-info"><Meta project={p} index={6} /><p>AN URBAN HOME AS A LIVING LANDSCAPE.</p></div></article>; }
